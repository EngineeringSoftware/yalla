...
double run_work(Kokkos::View<double **, Kokkos::LayoutRight, pk_arg_memspace,
  ...
  pk_functor_work pk_f(&pk_d_v, &pk_d_mass, &pk_d_type);
  Kokkos::parallel_reduce(
      pk_kernel_name,
      Kokkos::RangePolicy<pk_exec_space,
                          pk_functor_work::work_tag>(
...
double wrapper_work(pybind11::kwargs kwargs) {
  return run_work(
      kwargs["v"]
...
PYBIND11_MODULE(
    PLACEHOLDER, k) {
  k.def("wrapper_work", &wrapper_work);
}