BUILD_DIR=/home/nalawar/projects/yalla/eval/projects/opencv/build

g++ -Wl,--gc-sections -Wl,--as-needed -Wl,--no-undefined drawing.yalla.o wrappers.yalla.o -o a.out  \
  -Wl,-rpath,/home/nalawar/projects/yalla_env/other_projects/opencv/build/lib  -ldl  -lm  -lpthread  -lrt  ${BUILD_DIR}/3rdparty/lib/libippiw.a \
